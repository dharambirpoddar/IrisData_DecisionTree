...
dot_data = tree.export_graphviz(cf, out_file=None,feature_names=irisset.feature_names,class_names=irisset.target_names,filled=True, rounded=True, special_characters=True)  
graph = graphviz.Source(dot_data)  
